    ...
    <div class="landing-hero">
      ...
      <h1 class="main-header">
        ...
        <div class="animate-strong">
          <span>
            <strong v-for="projectType in tags.projectTypes" :key="projectType.id" class="main-header-strong">
      ...
      <div class="button-group">
        ...
        <nuxt-link v-if="!auth.user" to="/auth/sign-up" class="iconified-button outline-button" rel="noopener nofollow">
          Sign up
        </nuxt-link>
      ...
      <div class="projects-showcase">
        <div v-for="(row, index) in rows" :key="index" class="row">
          <div v-for="n in 2" :key="n" class="row__content" :class="{ offset: index % 2 }">
            <nuxt-link v-for="project in row" :key="project.id" class="project button-animation"
            ...
            <div class="demo-search">
              <div class="search-controls">
                <div class="iconified-input">
                  ...
                  <input id="search" v-model="searchQuery" type="search" name="search" :placeholder="`Search...`"
                    autocomplete="off" @input="updateSearchProjects" />
                </div>
                <div class="sort-by">
                  <span class="label">Sort by</span>
                  <Multiselect v-model="sortType" placeholder="Select one" class="selector"
                    :custom-label="(value) => value.charAt(0).toUpperCase() + value.slice(1)"
                    :options="['relevance', 'downloads', 'follows', 'updated', 'newest']" :searchable="false"
              ...
              <div class="results display-mode--list">
                <ProjectCard v-for="result in searchProjects" :id="result.slug ? result.slug : result.project_id"
                  :key="result.project_id" class="small-mode gradient-border" :type="result.project_type"
                  :author="result.author" :name="result.title" :description="result.description"
                  :created-at="result.date_created" :updated-at="result.date_modified"
                  :downloads="result.downloads.toString()" :follows="result.follows.toString()"
                  :icon-url="result.icon_url" :client-side="result.client_side" :server-side="result.server_side"
                  :categories="result.display_categories.slice(0, 3)" :search="true" :show-updated-date="true"
                  :color="result.color" />
              </div>
            </div>
          </div>
          ...
          <div class="blob-demonstration gradient-border">
            <div class="notifs-demo">
              ...
              <div class="notifications">
                <div v-for="(notification, index) in notifications" :key="index" class="notification gradient-border">
                  <nuxt-link :to="`${notification.project_type}/${notification.slug}`" :title="notification.title">
                    <Avatar size="md" :src="notification.icon_url" :alt="notification.title" />
                  </nuxt-link>
                  <div>
                    <nuxt-link :to="`${notification.project_type}/${notification.slug}`" class="notif-header">
        ...
        <div class="feature-blob">
          ...
          <div class="blob-demonstration gradient-border">
            <div class="launcher-view">
              <img v-if="$colorMode.value === 'light'" src="https://cdn.modrinth.com/landing-new/launcher-light.webp"
                alt="launcher graphic" class="minecraft-screen" />
              <img v-else src="https://cdn.modrinth.com/landing-new/launcher.webp" alt="launcher graphic"
                class="minecraft-screen" />
              <div class="launcher-graphics">
                <a rel="noopener" href="https://prismlauncher.org/" class="graphic gradient-border"
                ...
                <a rel="noopener" href="https://atlauncher.com/" class="graphic gradient-border" title="ATLauncher">
                  <ATLauncherLogo />
                </a>
              </div>
            </div>
        ...
        <div class="feature gradient-border">
          <div class="icon gradient-border">
            <svg viewBox="0 0 46 24" fill="none">
              ...
              <defs>
                <linearGradient id="paint0_linear_127_321" x1="23" y1="0.5" x2="23" y2="23.5"
                  gradientUnits="userSpaceOnUse">
                  <stop stop-color="#C1E1B1" />
                  <stop offset="1" stop-color="#A7BDE6" />
                </linearGradient>
        ...
        <div class="feature gradient-border">
          <div class="icon gradient-border">
            <svg viewBox="0 0 42 30" fill="none">
              ...
              <defs>
                <linearGradient id="paint0_linear_127_325" x1="21" y1="0.625" x2="21" y2="29.375"
                  gradientUnits="userSpaceOnUse">
                  <stop stop-color="#C1E1B1" />
                  <stop offset="1" stop-color="#A7BDE6" />
                </linearGradient>
    ...
    .feature-blob {
      ...
      .blob-demonstration {
        ...
        &:after {
          ...
          background: linear-gradient(0deg, #f60777 0%, rgba(206, 5, 139, 0) 100%);
          opacity: 0.2;
          border-radius: 1rem;
          margin-top: auto;
...
.main-header-strong {
  ...
  background-image: linear-gradient(180deg, #ffa7c7 0%, var(--color-brand) 60%);
  background-size: 100%;
