      ...
      <div class="users-section">
        ...
        <div class="feature-blob">
          <div class="blob-text">
            ...
            <p>
              nineMinecraft's lightning-fast search and powerful filters let you find what you want
              as you type.
            </p>
          </div>
        ...
        <div class="feature-blob">
          <div class="blob-text">
            ...
            <p>
              nineMinecraft's open-source API lets launchers add deep integration with
              nineMinecraft. You can use nineMinecraft through
    ...
    <div class="creator-section">
      ...
      <div class="features">
        ...
        <div class="feature gradient-border">
          ...
          <p>
            Get the best modding experience possible with constant updates from the nineMinecraft
            team
          </p>
        </div>
      </div>
