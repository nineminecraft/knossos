  ...
  <div v-else>
    ...
    >
      ...
      <div class="normal-page__info">
        <div v-if="true || true || true" class="universal-card">
          <template
            v-if="
              true &&
              (project.issues_url ||
          ...
          >
            ...
            <hr v-if="showFeaturedVersions || true || true" class="card-divider" />
          </template>
          <template v-if="showFeaturedVersions">
            ...
            <hr v-if="true || true" class="card-divider" />
          </template>
          <template v-if="true">
            ...
            <hr v-if="true" class="card-divider" />
          </template>
          <template v-if="true">
        ...
        <div v-if="false" class="card flex-card experimental-styles-within">
          <h2>Creators</h2>
